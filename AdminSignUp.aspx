...
<body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="AdminSignUp.aspx">As Admin</a></li>
                                </ul>
        ...
        <div class="center-page">
            ...
            <div class="col-xs-11">
                <asp:TextBox ID="tbDOB" runat="server" CssClass="form-control" placeholder="Date of Birth"></asp:TextBox>
            </div>
