<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollectedBloodList.aspx.cs" Inherits="CollectedBloodList" %>
...
<body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UserConnectionString %>" SelectCommand="SELECT * FROM [CollectedBlood]"></asp:SqlDataSource>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="Date_of_Donating_Blood" HeaderText="Date_of_Donating_Blood" SortExpression="Date_of_Donating_Blood" />
            </Columns>
