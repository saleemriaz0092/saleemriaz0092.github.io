<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BloodDonatingForm.aspx.cs" Inherits="BloodDonatingForm" %>
        ...
        <div class="container">
            <div class="form-horizontal">
                ...
                <div class="center-page">
                    ...
                    <div class="col-xs-11">
                        <asp:DropDownList ID="tbgender" runat="server" Class="form-control">
                    ...
                    <div class="col-xs-11">
                        <asp:DropDownList ID="tbBG" runat="server" Class="form-control" placeholder="Please select your blood group!">
                    ...
                    <label class="col-xs-11">Date Of Donating Blood</label>
                    <div class="col-xs-11">
                        <asp:TextBox ID="tbDODB" runat="server" Class="form-control" placeholder="Blood Donating Date" TextMode="Date"></asp:TextBox>
                    </div>
                    <div class="col-xs-11 space-vert2">
                        <asp:Button ID="btnDonorsubmit" runat="server" CssClass="btn btn-success" Text="Submit" OnClick="btnDonorsubmit_Click" />
                        <asp:Button ID="btnDonorCancel" runat="server" CssClass="btn btn-success" Text="Cancel" />
                    </div>
