...
<head runat="server">
    ...
    <title>Welcome In Admin Home</title>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="CollectedBloodList.aspx">Blood Collection</a></li>
                        <li><a href="requestbloodresult.aspx">Blood Requests</a></li>
                        <li class="dropdown">                                                                                                                                                                   
                            </li>
                        <li><a href="DonorsList.aspx">Donor List</a></li>
                      <li><asp:Button ID="btnAdminSignout" runat="server" CssClass="btn btn-default navbar-btn" Text="Logout" OnClick="btnAdminSignout_Click" /> </li>
                    </ul>
                </div>
            </div>
