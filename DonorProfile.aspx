<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonorProfile.aspx.cs" Inherits="SignUp" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="center-page">
                    ...
                    <div class="col-xs-11 space-vert">
                        <asp:TextBox ID="tbuname" runat="server" CssClass="form-control" placeholder="Username" OnTextChanged="tbuname_TextChanged"></asp:TextBox>
                       <asp:Label ID="Label2" runat="server" ForeColor="Red"></asp:Label>
                       
                    </div>
                    <label class="col-xs-11">FirstName</label>
                    <div class="col-xs-11">
                        <asp:TextBox ID="tbfn" runat="server" CssClass="form-control" placeholder="FirstName"></asp:TextBox>
                    </div>
                    ...
                    <div class="col-xs-11">
                        ...
                        <div class="col-xs-11">
                            <asp:DropDownList ID="dc" runat="server" CssClass="form-control">
                        ...
                        <div class="col-xs-11 space-vert">
                            <asp:Button ID="btnsignup" runat="server" CssClass="btn btn-success" Text="Submit" OnClick="btnsignup_Click" />
